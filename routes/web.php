...
Route::post('/contact',[InquiryController::class,'contact'])->name('contact.store');
Route::get('/custom-order',[PageController::class,'customOrder'])->name('pages.custom-order');
Route::post('/custom-order',[InquiryController::class,'customOrder'])->name('custom-order.store');
