...
class AdminCmsTest extends TestCase
{
    ...
    {
        foreach ([
            'admin.dashboard', 'admin.products.index', 'admin.categories.index', 'admin.orders.index',
            'admin.projects.index', 'admin.coupons.index', 'admin.discount-rules.index', 'admin.media.index',
            'admin.menus.index', 'admin.settings.edit', 'admin.users.index', 'admin.roles.index', 'admin.reports.index',
        ] as $route) {
    ...
    public function test_public_projects_and_sitemap_render(): void
    {
